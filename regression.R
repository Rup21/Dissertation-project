...
data=data.frame(y1,y2,X1,X2,X3,X4,X5,X6);data

# raw data regression 
model1 = lm(y1~ X1+X2+X3+X4+X5+X6);model1;summary(model1)
model2 = lm(y2~ X1+X2+X3+X4+X5+X6);model2;summary(model2)


# final regression
data=cbind(data,X7,X8)
